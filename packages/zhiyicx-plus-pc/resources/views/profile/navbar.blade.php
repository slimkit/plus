...
<div class="m-uchead profile_top">
    <div class="profile_top_cover" style="background-image: url({{ $user['bg']['url'] ?? asset('assets/pc/images/default_cover.jpg') }});background-repeat: no-repeat;background-size: cover;"> </div>
