        ...
        <div class="list-item" id="answer{{$answer->id}}">
            ...
            <div class="list-item-content">
                ...
                <div class="answer-footer">
                    ...
                    {{-- 评论 --}}
                    @include('pcview::widgets.comments', ['id' => $answer->id, 'comments_count' => $answer->comments->count(), 'comments_type' => 'answer', 'url' => Route('pc:answeread', ['question' => $answer->question_id, 'answer' => $answer->id]), 'position' => 1, 'comments_data' => $answer->comments])
