...
@if (!empty($comments))
    ...
    <script>
        ...
        $('.comment_audit').on('click', 'a', function () {
            ...
            if (data.type == 1) {
                url = '/api/v2/news/' + data.news_id + '/comments/' + data.comment_id + '/currency-pinneds/' + data.pinned_id;
            } else {
                url = '/api/v2/news/' + data.news_id + '/comments/' + data.comment_id + '/currency-pinneds/' + data.pinned_id + '/reject';
            }
