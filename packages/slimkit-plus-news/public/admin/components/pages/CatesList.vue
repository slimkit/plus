            ...
            <table class="table table-hover table-bordered table-responsive table-middle">
                ...
                <tbody>
                    <tr v-for="cate in cates" :key="cate.id">
                        ...
                        <td>{{cate.rank}}</td>
                        <td>
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" @click="cur_cate = cate">编辑</button>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="rank" placeholder="请输入分类权重, 默认为0" v-model.number="cur_cate.rank" />
                            </div>
                        </div>
                        <!-- /权重 -->
                    </div>
