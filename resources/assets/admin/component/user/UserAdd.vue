    ...
    <div class="panel panel-default form-horizontal">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input min="6" max="16" type="password" autocomplete="new-password" class="form-control" id="password" aria-describedby="password-help-block" placeholder="请输入用户密码,6位，防止前端不能登录" v-model="password">
          </div>
