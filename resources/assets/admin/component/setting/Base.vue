...
<template>
  <form class="form-horizontal app-setting-base-container">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="site-title" aria-describedby="site-title-help-block" placeholder="输入网站标题">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="site-keywords" aria-describedby="site-keywords-help-block" placeholder="网站关键词">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="site-description" aria-describedby="site-description-help-block" placeholder="网站描述">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="site-icp" aria-describedby="site-icp-help-block" placeholder="网站描述">
      </div>
