    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <div class="form-inline">
                ...
                <div class="form-group">
                    <router-link :to="{ path: '/currency/cashes', query: filters }" class="btn btn-default">确认</router-link>
                </div>
            </div>
        </div>
                ...
                <template v-if="!loading">
                    ...
                    <tbody>
                        <tr v-for="item in items">
                            ...
                            <td>
                                <button @click="handleAudit(item.id,1)" class="btn btn-primary btn-sm" :disabled="item.state != 0">通过</button>
                                <button @click="handleAudit(item.id,-1)" class="btn btn-danger btn-sm" :disabled="item.state != 0">拒绝</button>     
                            </td>
                        </tr>
                    </tbody>
                </template>
