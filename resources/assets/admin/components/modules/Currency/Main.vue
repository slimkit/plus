            ...
            <nav class="navbar navbar-default navbar-fixed-top" style="position: absolute;">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  ...
                  <ul class="nav navbar-nav">
                    <router-link to="/currency" tag="li" active-class="active" exact>
                      <a href="#">基础配置</a>
                    </router-link>
                    <router-link to="/currency/statistics" tag="li" active-class="active" exact>
                      <a href="#">统计</a>
                    </router-link>
                    <router-link to="/currency/cashes" tag="li" active-class="active" exact>
                      <a href="#">提现审批</a>
                    </router-link>
                  </ul>
                </div>  
