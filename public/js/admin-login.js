...
/******/ 	__webpack_require__.p = "http://plus.io/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.createRequestURI = undefined;
	...
	var baseRUL = window.TS.baseRUL; // This "TS" variable is set from the global variables in the template.
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ADMIN_LOGIN = undefined;
	
	var _request = __webpack_require__(111);
	
	// Administrator Login API.
	var ADMIN_LOGIN = exports.ADMIN_LOGIN = (0, _request.createRequestURI)('login');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _APIs = __webpack_require__(131);
	...
	var LoginForm = {
	  ...
	  methods: {
	    onSubmit: function onSubmit() {
	      ...
	      _request2.default.post(_APIs.ADMIN_LOGIN, {
	        phone: phone,
	        password: password
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/usr/local/var/www/thinksns-plus/resources/assets/admin/components/LoginForm.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-82d62cf0", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-82d62cf0", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] LoginForm.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-82d62cf0", module.exports)
	  }
	}
